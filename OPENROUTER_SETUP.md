...
- **Best for**: General purpose, reasoning tasks, code review
...
The system automatically detects `USE_OPENROUTER` and switches between OpenAI and OpenRouter. All code review agents (Security, Performance, Style, Documentation, Best Practices) will use the configured provider. No code changes needed!
