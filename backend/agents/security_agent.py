...
class SecurityAgent(BaseCodeReviewAgent):
    ...
    def __init__(
        self, model_name: str = "gpt-4", temperature: float = 0.2, api_key: str = None
    ):
        """
...
Format your response clearly with prioritized issues."""
        ...
        vulnerabilities = self._extract_vulnerabilities(
            analysis_result, pattern_matches
        )
    ...
    def _load_security_patterns(self) -> Dict[str, List[str]]:
        ...
        return {
            ...
            "eval_usage": ["eval(", "exec(", "__import__", "compile("],
            "insecure_random": ["random.", "randint", "choice("],
    ...
    def _extract_vulnerabilities(
        self, analysis_text: str, pattern_matches: List[Dict[str, Any]]
    ) -> List[Dict[str, Any]]:
        ...
        for line in lines:
            ...
            if any(
                ...
                for keyword in ["vulnerability", "security", "risk", "insecure"]
            ):
                if current_vuln:
